...
{
  CountlyConnectionQueue::sharedInstance()->setStartedWithTest(true);
...
- (void)didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken {
  ...
  CountlyConnectionQueue::sharedInstance()->tokenSession([token cStringUsingEncoding:NSUTF8StringEncoding], "ios_token");
}

- (void)didFailToRegisterForRemoteNotifications {
  CountlyConnectionQueue::sharedInstance()->tokenSession("", "ios_token");
}
