...
public class Message implements Parcelable {
    ...
    public String getUpdate() { return data.getString("c.u"); }
    ...
    private int setType() {
        ...
        if (getUpdate() != null) { //&& !"".equals(getUpdate())
            t |= CountlyMessaging.NOTIFICATION_TYPE_UPDATE;
        }
    ...
    public boolean hasUpdate() { return (type & CountlyMessaging.NOTIFICATION_TYPE_UPDATE) > 0; }
